...
BlogApp es una aplicación web full-stack que permite a los usuarios registrarse, iniciar sesión, crear y gestionar sus propias publicaciones de blog. La aplicación está construida con un backend en Spring Boot que expone una API REST y un frontend en Angular.
